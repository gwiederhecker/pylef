...
##### test commands ###########
    def aquisition_params(self):
        ...
        return self.instr.query('ACQuire?').split(':')[2:]
#    
...
#
    def set_trigger_source(self, source):
        ...
        if source in self.trigger_list:
            ...
            raise ValueError('The trigger should be one of those: ', self.trigger_list)
#
